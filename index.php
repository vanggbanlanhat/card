...
<html class="light-style layout-menu-fixed" data-theme="theme-default" data-assets-path="https://taophoi.com/assets/"
    data-base-url="https://ToiCode.Net" data-framework="laravel" data-template="vertical-menu-laravel-template-free">


    <!-- Mirrored from taophoi.com/taokieuphoi/loai1 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Aug 2022 02:59:43 GMT -->
    <!-- Added by HTTrack -->
    ...
    <head>
        ...
        <title>Tạo phôi | ToiCode.Net - Tài trợ miễn phí công cụ này </title>
        <meta name="description" content="ToiCode.Net - Tài trợ miễn phí công cụ này" />
        <meta name="keywords" content="ToiCode.Net - Tài trợ miễn phí công cụ này">
        <!-- laravel CRUD token -->
    ...
    <body>
            ...
            <div class="layout-container">
                ...
                <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                    ...
                    <div class="app-brand demo">
                        <a href="https://taophoi.com/" class="app-brand-link">
                            ...
                            <span class="app-brand-text demo menu-text fw-bold ms-2">TaoPhoi.com</span>
                        </a>
                    ...
                    <ul class="menu-inner py-1">
                        ...
                        <li class="menu-item ">
                            <a href="https://ToiCode.Net/2FA" class="menu-link">
                        ...
                        <li class="menu-item ">
                            <a href="https://ToiCode.Net/" class="menu-link">
                        ...
                        <li class="menu-item ">
                            <a href="https://ToiCode.Net/shareads" class="menu-link">
                ...
                <div class="layout-page">
                            ...
                            <div class="navbar-nav align-items-center">
                                <div class="nav-item d-flex align-items-center">
                                    ...
                                    <label style="font-size:1.0 em;margin-left:10px;color:#f31111;font-weight:bold"> <a
                                            href="https://ToiCode.Net/">ToiCode.Net</a> - Cung cấp miễn phí công cụ
                                        này!</label>
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="container-xxl flex-grow-1 container-p-y">
                            ...
                            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tạo phôi /</span> Bằng lái
                                xe California</h4>
                            <style>
                            #datepicker {
                                width: 250px;
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-header d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="col-xxl " style="padding-left 10%;">
                                                <img class="card-img-top" src="assets/img/phoi/phoi1.png"
                                                    style="height:120px;width:200px;margin-left:10%"
                                                    alt="Card image cap" />
                                            </div>
                                            ...
                                            <form>
                                                <div class="row mb-3">
                                                    <label class="col-sm-2 col-form-label"
                                                        for="basic-default-name">Họ</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="row mb-3" style="display:none">
                                                    <label class="col-sm-2 col-form-label"
                                                        for="basic-default-company">Tên đệm</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="tendem1"
                                                            placeholder="Văn" />
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label class="col-sm-2 col-form-label"
                                                        for="basic-default-email">Tên</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="row mb-3">
                                                    <label class="col-sm-2 col-form-label"
                                                        for="basic-default-phone">Link ảnh</label>
                                                    <div class="col-sm-5">
                                                    ...
                                                    <div class="col-sm-5">
                                                        ...
                                                        <label style="margin-left:10px;" class=""
                                                            for="basic-default-phone">Random Ảnh</label>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label class="col-sm-2 col-form-label"
                                                        for="basic-default-phone">Giới tính</label>
                                                    <div class="col-sm-1">
                                                        <input readonly type="text" id="txtGioiTinh" value="F"
                                                ...
                                                <div class="row mb-3">
                                                    <label class="col-sm-2 col-form-label"
                                                        for="basic-default-message">Ngày sinh</label>
                                                    <div class="col-sm-10">
                            ...
                            const gioitinhCheckbox = document.getElementById('gioitinhCheckbox')
                            gioitinhCheckbox.addEventListener('change', (event) => {
                            ...
                            checkbox.addEventListener('change', (event) => {
                                if (event.currentTarget.checked) {
                                    ...
                                    $("#link").val("https://www.thispersondoesnotexist.com/image");
                                } else {
                            ...
                            function submitData(id) {
                                ...
                                let gioitinh = $("#gioitinhCheckbox").is(":checked") == true ? "M" : "F";
                        ...
                        <footer class="content-footer footer bg-footer-theme">
                            <div
                                ...
                                <div class="mb-2 mb-md-0">
                                    ...
                                    , made with ❤️ by <a href="https://ToiCode.Net/" target="_blank"
                                        class="footer-link fw-bolder">ThemeSelection</a>
                                </div>
                                <div>
                                    <a href="https://themeselection.com/license/" class="footer-link me-4"
                                        target="_blank">License</a>
                                    <a href="https://ToiCode.Net/" target="_blank" class="footer-link me-4">More
                                        Themes</a>
        ...
        <div class="buy-now">
            <a href="https://ToiCode.Net/" target="_blank" class="btn btn-danger btn-buy-now">Go to ToiCode.Net</a>
        </div>


        <!-- Include Scripts -->
        <script src="https://taophoi.com/assets/vendor/libs/jquery/jquery.js?id=6c6bb30e07aa97fd50fc3c7851ba13bb">
        </script>
        <script src="https://taophoi.com/assets/vendor/libs/popper/popper.js?id=61e75f9a655f09a516ed35dde1d4d37a">
        </script>
        <script src="https://taophoi.com/assets/vendor/js/bootstrap.js?id=beb512856958fada3aca645728f44107"></script>
        <script
            src="https://taophoi.com/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js?id=3f751bf441a2e50654697fe701ad7eb7">
        </script>
        <script src="https://taophoi.com/assets/vendor/js/menu.js?id=14e4fc6ab23e4525ff1c16db2078657c"></script>
        <script src="https://taophoi.com/assets/vendor/libs/masonry/masonry.js"></script>
        <!-- END: Page Vendor JS-->
        <!-- BEGIN: Theme JS-->
        <script src="https://taophoi.com/assets/js/main.js?id=5971037ce98c7a1fb1c8931365d154ea"></script>
    ...
    <!-- Mirrored from taophoi.com/taokieuphoi/loai1 by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Aug 2022 02:59:55 GMT -->
